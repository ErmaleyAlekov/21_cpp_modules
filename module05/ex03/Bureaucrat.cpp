...
/*   Updated: 2021/12/01 02:17:40 by uterese          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm(Form &obj) const
{
	...
	{
		obj.getSigned(*this);
		std::cout << GRN << getName() << " signed " << obj.getName() << std::endl;
	}
	catch(std::exception& e)
	{
		std::cout << RED << getName() << " cannot sign " << obj.getName() \
...
void Bureaucrat::executeForm(Form const &form)
{
	...
	{
		form.execute(*this);
		std::cout << GRN << getName() << " executed " << form.getName() << std::endl;
	}
	catch(const std::exception& e)
	{
		std::cout << RED << getName() << " cannot execute " << form.getName() \
			 << " because " << e.what() << std::endl;
	}
}