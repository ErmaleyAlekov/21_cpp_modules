...
/*   Updated: 2021/10/20 13:45:46 by uterese          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    Karen::info (void)
{
    ...
    std::cout <<  GRN"You don’t put enough! If you did I would not have to askfor it!" << std::endl;
}
...
void    Karen::debug (void)
{
    ...
    std::cout << GRN"7XL-double-cheese-triple-pickle-special-ketchup burger. I just love it!" << std::endl;
}
...
void    Karen::warning (void)
{
    ...
    std::cout << GRN"I’ve beencoming here for years and you just started working here last month." << std::endl;
}

void    Karen::error(void)
{
    std::cout << GRN"[ERROR]" << std::endl;
	std::cout << GRN"This is unacceptable, I want to speak to the manager now." << std::endl;
}
